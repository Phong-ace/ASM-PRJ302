...
(N'Nguyễn Văn A', N'nguyenvana@example.com', 'password1', N'Owner', N'0901234567', N'Hà Nội'),
(N'Trần Thị B', N'tranthib@example.com', 'password2', N'Inspector', N'0912345678', N'Hồ Chí Minh'),
(N'Lê Văn C', N'levanc@example.com', 'password3', N'Station', N'0923456789', N'Đà Nẵng'),
(N'Phạm Quốc D', N'phamquocd@example.com', 'password4', N'Police', N'0934567890', N'Cần Thơ'),
(N'Đặng Hoàng E', N'danghoange@example.com', 'password5', N'Admin', N'0945678901', N'Hải Phòng');
...
(N'Trung tâm đăng kiểm TP.HCM', N'456 Đường XYZ, Hồ Chí Minh', N'0976543210', N'dangkiem_hcm@example.com', 3);
